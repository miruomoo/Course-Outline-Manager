...
// Defining the function responsible for the new course outline 
function EditCourseOutline() {
    ...
    const saveCourseOutline = () => {
        // Var of the current content situation
...
export default EditCourseOutline;
